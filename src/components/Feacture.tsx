  ...
  return (
    <>
      ...
      <section className="relative container max-w-screen-xl py-0 md:py-5 px-0 md:px-4 mx-auto overflow-x-hidden">
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:gap-x-5 md:gap-x-8 p-3 lg:p-0 ">
          {/* 1 */}
          {/* <div className='w-full'> */}
          <div className="w-full bg-[] rounded-[10px] p-4 xl:p-0 md:mt-[50px] lg:mt-[-50px]">
            <Image src={section2} alt="image"></Image>
            {/* <Image></Image> */}
          </div>
          <div className="w-full flex flex-col justify-center md:mt-[50px] lg:mt-[-50px]">
          ...
          <div className="w-full flex flex-col justify-center lg:ml-[15%] md:mt-[50px] lg:mt-[-50px]">
          ...
          <div className="w-full bg-[] rounded-[10px] p-4 mb-4 mx-auto lg:ml-[12%] md:mt-[50px] lg:mt-[-50px]">
            <Image src={section21} alt="logo"></Image>
          </div>

          {/* 3 */}
          <div className="w-full bg-[] rounded-[10px] p-4 md:mt-[50px] lg:mt-[-50px]">
            <Image src={section2} alt="image"></Image>
            {/* <Image></Image> */}
          </div>
          <div className="w-full flex flex-col justify-center md:mt-[50px] lg:mt-[-50px]">
      ...
      <div className="xl:flex lg:flex justify-between container mx-auto relative xl:px-[110px] lg:top-[-70px] hidden">
        <Image src={star1} width={0} height={0} alt="logo" />
        <div>
          <Image src={star2} width={0} height={0} alt="logo" />
        </div>
      </div>
      <section className="container max-w-screen-xl justify-center flex relative mx-auto px-4 lg:mt-[-120px]">
